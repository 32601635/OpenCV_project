...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_zoom_in.setGeometry(QtCore.QRect(180, 520, 80, 40))
        font = QtGui.QFont()
        ...
        self.btn_zoom_out.setGeometry(QtCore.QRect(690, 520, 80, 40))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(10)
        ...
        self.label_ratio.setGeometry(QtCore.QRect(780, 530, 100, 25))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.slider_zoom.setGeometry(QtCore.QRect(280, 530, 391, 22))
        ...
        self.label_click_pos.setGeometry(QtCore.QRect(930, 520, 275, 25))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(10)
        ...
        self.label_norm_pos.setGeometry(QtCore.QRect(930, 570, 275, 25))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(10)
        ...
        self.label_real_pos.setGeometry(QtCore.QRect(930, 620, 275, 25))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(10)
        ...
        self.label_info_ratio_roi.setGeometry(QtCore.QRect(80, 570, 90, 12))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        ...
        self.text_ratio_roi.setGeometry(QtCore.QRect(170, 570, 225, 71))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        ...
        self.label_info_real_roi.setGeometry(QtCore.QRect(410, 570, 90, 12))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        ...
        self.text_real_roi.setGeometry(QtCore.QRect(500, 570, 225, 71))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_click_pos.setText(_translate("MainWindow", "clicker position = (x, y)"))
